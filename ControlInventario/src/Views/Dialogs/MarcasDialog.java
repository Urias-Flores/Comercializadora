...
import ViewsControllers.MarcaDialogViewController;

public class MarcasDialog extends javax.swing.JDialog {

    private int X, Y;
    MarcaDialogViewController vc;
    ...
    private void btnEliminarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEliminarMouseClicked
        switch (vc.Eliminar()) {
            case -2:
                Dialogs.ShowGeneralDialog("Upps... Ha ocurrido un error inesperado", Dialogs.ERROR_ICON);
                break;
            case -1:
                Dialogs.ShowGeneralDialog("Seleccione una marca de la lista", Dialogs.ERROR_ICON);
                break;
            case 0:
                Dialogs.ShowGeneralDialog("La marca ha sido eliminada exitosamente", Dialogs.COMPLETE_ICON);
                vc.cargarMarcas();
                break;
            case 1:
                Dialogs.ShowGeneralDialog("La eliminacion ha sido cancelada", Dialogs.ERROR_ICON);
                break;
            default:
