...
public class Usuarios extends javax.swing.JPanel {
    ...
    private void btnEliminarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEliminarMouseClicked
        if(true){
            ...
            Dialogs.ShowGeneralDialog("¡El usuario ha sido eliminado exitosamente", Dialogs.DELETE_ICON);
        }
    }//GEN-LAST:event_btnEliminarMouseClicked

    private void btnDesactivarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnDesactivarMouseClicked
        if(true){
            //Codigo de desactivacion de usuario
            Dialogs.ShowGeneralDialog("¡El usuario a sido desactivado exitosamente!", Dialogs.COMPLETE_ICON);
        }
