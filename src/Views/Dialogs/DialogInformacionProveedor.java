...
public class DialogInformacionProveedor extends javax.swing.JDialog {
    ...
    public DialogInformacionProveedor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void Load(){
       conPro = new ControllerProveedor(ProveedorID);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("A cerca del proveedor");
        ...
        lbSaldo.setFont(new java.awt.Font("Cascadia Mono", 1, 18)); // NOI18N
        lbSaldo.setText("0.0");
        ...
        lbNumero.setFont(new java.awt.Font("Cascadia Mono", 1, 18)); // NOI18N
        lbNumero.setText("Nombre");

        jLabel13.setFont(new java.awt.Font("Cascadia Mono", 0, 18)); // NOI18N
        jLabel13.setText("Correo electronico");

        lbCorreo.setFont(new java.awt.Font("Cascadia Mono", 1, 18)); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogInformacionProveedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            DialogInformacionProveedor dialog = new DialogInformacionProveedor(new javax.swing.JFrame(), true);
